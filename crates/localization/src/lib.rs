...
pub struct TextResources {
	...
	pub start_shortcut: SettingText,
	pub start_button_click: SettingText,
	pub group_columns: SettingText,
	pub tiles_per_row: SettingText,
	pub rounded_tiles: SettingText,
	pub rounded_tile_bars: SettingText,
	pub tile_animation_duration: SettingText,
	pub tile_background_opacity: SettingText,
	pub tile_bar_background_opacity: SettingText,
	pub restart_shell: SettingText,
	pub restart_now: String,
	pub on: String,
	pub off: String,
	pub undo: String,
	pub save: String,
	pub shortcut_win_shift: String,
	pub shortcut_win: String,
